# python GAN_train_vae.py --new_model
# python GAN_train_vae.py
...
def main(args):
  ...
  if not new_model:
    try:
      ...
      print("Either set --new_model or ensure ./vae exists")
      raise
...
if __name__ == "__main__":
  ...
  parser.add_argument('--N',default = 10, help='number of episodes to use to train')
