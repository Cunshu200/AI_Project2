...
#xvfb-run -a -s "-screen 0 1400x900x24" python check5.py

# Command we use
# xvfb-run -a -s "-screen 0 1400x900x24" python 05_train_controller.py car_racing -n 4 -t 2 -e 2 --max_length 500
# xvfb-run -a -s "-screen 0 1400x900x24" python 05_train_controller.py car_racing -n 3 -t 2 -e 2 --max_length 500 --dream_mode 1
