# python GAN_03_generate_rnn_data.py
...
def main(args):
    ...
    try:
      ...
      print(e)
      print("./vae/GAN_weights2.h5 does not exist - ensure you have run 02_train_vae.py first")
      raise
...
if __name__ == "__main__":
  ...
  parser.add_argument('--N',default = 6000, help='number of episodes to use to train')
